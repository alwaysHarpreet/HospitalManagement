  ...
  return (
    <div className="order-history">
      <header className="order-history__header">
        <h1 className="order-history__header-title">Order Page</h1>
      </header>
      <main className="order-history__main">
        {/* <SearchBar /> */}
        <div className="order-history__search-bar">
          <input
            type="text"
            placeholder="Search your orders here"
            className="order-history__search-input"
            onChange={(e) => {
          ...
          />
          <button
            className="order-history__search-btn"
