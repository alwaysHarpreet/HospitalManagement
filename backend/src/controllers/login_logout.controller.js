...
export const login = asyncHandler(async (req, res, next) => {
    ...
    // reCAPTCHA verification disabled for local development
...
//! Logout Lab Technician
export const logoutLabTech = asyncHandler(async (req, res, next) => {
    res
        .status(200)
        .cookie("labTechToken", "", {
            expires: new Date(Date.now()),
        ...
        .json({
            success: true,
            message: "Lab Technician logged out Successfully"
        });
})