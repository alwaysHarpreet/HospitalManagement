...
app.use(
  cors({
    origin: [process.env.FRONTEND_URL, process.env.DASHBOARD_URL, process.env.DOCTOR_URL, process.env.LAB_PORTAL_URL],
...
import labTechRouter from "./src/routes/labtech.routes.js";
...
app.use("/api/v1/labtech", labTechRouter)
